...
/**
 * @Route("excursions/grille")
 */
class GrilleController extends AbstractController
{
    /**
     * @Route("/", name="app_excursions_grille_tarifaire_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="app_excursions_grille_tarifaire_new", methods={"GET", "POST"})
     */
    public function new(Request $request, GrilleTarifaireRepository $grilleTarifaireRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_excursions_grille_tarifaire_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    /**
     * @Route("/{id}", name="app_excursions_grille_tarifaire_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="app_excursions_grille_edit", methods={"GET", "POST"})
     */
    public function edit(Request $request, GrilleTarifaire $grilleTarifaire, GrilleTarifaireRepository $grilleTarifaireRepository): Response
    {
        ...
        return $this->renderForm('excursions/grille_tarifaire/edit.html.twig', [
            'grille_tarifaire' => $grilleTarifaire,
            'form' => $form,
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="app_excursions_grille_tarifaire_delete", methods={"POST"})
     */
